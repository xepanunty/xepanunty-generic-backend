                    ...
                    <form class="col-md-12 p-t-10" role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" maxlength="9"
                                           class="form-control{{ $errors->has('nif') ? ' is-invalid' : '' }}" name="nif"
                                           id="nif-nif" value="{{ old('nif') }}">
                        ...
                        @if ($selectedPackage !== "PERSONAL" && $selectedPackage !== "SALES")
                            <div class="form-group">
                                ...
                                <div>
                                    <select {{$selectedPackage !== "FREE" ? 'readonly' : '' }} name="package"
                                            id="package"
                        ...
                        <div class="form-group">
                            <input type="checkbox"
                                   class="{{ $errors->has('terms_and_conditions') ? ' is-invalid' : '' }}"
                                   name="terms_and_conditions" id="terms_and_conditions">
                            <label class="control-label" for="terms_and_conditions"><a href="terms"
                                                                                       target="_blank"><span>{{ trans('app.terms_and_conditions') }}</span></a></label>
                        ...
                        <div class="form-group">
                            <input type="checkbox"
                                   class="{{ $errors->has('use_phone_in_transactions') ? ' is-invalid' : '' }}"
                                   name="use_phone_in_transactions" id="use_phone_in_transactions">
                            <label class="control-label"
                                   for="use_phone_in_transactions">{{ trans('app.use_phone_in_transactions') }}</label>
